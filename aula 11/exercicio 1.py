#Você é um aventureiro carregando uma mochila que comporta 3 itens, atualmente: uma espada, uma poção e um escudo. Ao longo da aventura, encontra um arco no chão e precisa decidir se o coloca na mochila ou não. Caso coloque, precisará descartar outro item da mochila a sua escolha.

inventario = ["espada", "escudo", "poção"]
print("Inventário inicial:", inventario)
pergunta = input("Você encontrou um arco em uma clareira. Deseja adicioná-lo ao inventário? (SIM/NÃO): ").lower()
